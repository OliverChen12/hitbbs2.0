...
----
{
  ...
  "detail":{
    "records":[
      {
        "collectCount":0,
        "avatar":"http://localhost:8080/static/upload/avatar/NPEteam/avatar.png",
        "title":"我是一个话题标题",
        "userId":1,
        "good":false,
...
----
{
  ...
  "detail": {
    "errors": [],
    "urls": ["http://localhost:8080/static/upload/avatar/NPEteam/avatar.png"]
  }
}
----
      ...
      "records": [
        {
          "inTime": 1548992961000,
          "topicId": 1,
          "commentUsername": "NPEteam",
          "upIds": "2",
          "id": 1,
          "topicUsername": "NPEteam",
          "title": "我是一个话题标题",
          "userId": 1,
          "content": "modify_comment_content"
        }
