package co.yiiu.hitbbs.util.identicon;

import co.yiiu.hitbbs.service.ISystemConfigService;
import co.yiiu.hitbbs.util.HashUtil;
import co.yiiu.hitbbs.util.MD5Util;
import co.yiiu.hitbbs.util.StringUtil;
import co.yiiu.hitbbs.util.identicon.generator.IBaseGenerator;
import co.yiiu.hitbbs.util.identicon.generator.impl.MyGenerator;
